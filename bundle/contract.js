  ...
  var require_random = __commonJS({
    "node_modules/@stablelib/random/lib/random.js"(exports) {
      ...
      function randomBytes4(length, prng = exports.defaultRandomSource) {
      ...
      function randomString(length, charset = ALPHANUMERIC, prng = exports.defaultRandomSource) {
        ...
        while (length > 0) {
          const buf = randomBytes4(Math.ceil(length * 256 / maxByte), prng);
    ...
    "node_modules/@stablelib/sha512/lib/sha512.js"(exports) {
      ...
      var SHA5122 = (
        ...
        function() {
          ...
          SHA5123.prototype.update = function(data, dataLength2) {
            if (dataLength2 === void 0) {
            ...
            var dataPos = 0;
            this._bytesHashed += dataLength2;
            if (this._bufferLength > 0) {
              while (this._bufferLength < exports.BLOCK_SIZE && dataLength2 > 0) {
            ...
            if (dataLength2 >= this.blockSize) {
              dataPos = hashBlocks(this._tempHi, this._tempLo, this._stateHi, this._stateLo, data, dataPos, dataLength2);
  ...
  var require_ed25519 = __commonJS({
    "node_modules/@stablelib/ed25519/lib/ed25519.js"(exports) {
      ...
      function edadd(p, q) {
        const a = gf(), b2 = gf(), c = gf(), d = gf(), e = gf(), f2 = gf(), g = gf(), h = gf(), t = gf();
        sub(a, p[1], p[0]);
        sub(t, q[1], q[0]);
        mul(a, a, t);
        add2(b2, p[0], p[1]);
  ...
  // contract/logic.js
  var CHIADO_TESTNET = "https://rpc.chiadochain.net";
  var PROTOCOL_CONTRACT_ADDRESS = "0x15Fd3b92Eda42b55C7c521DFff5fdeeC5d76D04a";
  ...
  async function getTransferEvent(transactionHash, lastBlockHeight, tokenIdfromState) {
    const provider = new ethers_exports.JsonRpcProvider(CHIADO_TESTNET);
    const receipt = await provider.getTransactionReceipt(transactionHash);
    if (!receipt) {
      throw new Error("Transaction not found or not yet mined");
    }
    const logs = receipt.logs.filter((log) => {
      return log.topics[0] === REVENUE_EVENT_TOPIC && // Event signature
      log.address === PROTOCOL_CONTRACT_ADDRESS;
    });
    if (logs.length === 0) {
    ...
    let iface = new ethers_exports.Interface(abi);
    ...
    if (blockHeight <= lastBlockHeight)
      throw new ContractError("Block height not valid");
    if (address !== PROTOCOL_CONTRACT_ADDRESS)
      throw new ContractError("Adrress is Invalid");
    if (tokenIdfromEvm !== tokenIdfromState)
      throw new ContractError("Token Id does not match");
  ...
  function handle_metering(state, action) {
